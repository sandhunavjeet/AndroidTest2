...
public class AddBookTest {
	...
	public void testAdminAddBook() throws Exception {
		...
		// Check first the initial state of the library 
...
//	/** 
//	 * Tests the scenario when the 
	// administrator wants to add a book, but is not logged in.
//	 * <ol>
//	 *  <li> The book to be added is created.
//	 *  <li> The book is added to the library by 
	// calling addBook from the library application.
